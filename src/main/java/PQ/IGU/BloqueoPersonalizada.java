 ...
 */
public class BloqueoPersonalizada extends javax.swing.JFrame {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnBloquear2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(29, 29, 29))
        );
    ...
    private void btnBloquearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBloquearActionPerformed
        ...
        if (tbTabla.getRowCount() > 0) {
            ...
            if (tbTabla.getSelectedRow() != -1) {
                ...
                control.bloquearTarjeta(numeroTarjeta);
    ...
    private void cargarTabla() {
        ...
        String titulos[] = {"ID", "ESTADO", "NOMBRE", "IDENTIFICACION", "SALDO"};
        tabla.setColumnIdentifiers(titulos);
        //carga de los datos de la base de datos
        List<TarjetaPersonalizada> listaTarjetas = control.traerTarjetas();
        //recorrer la lista y mostrar cada uno de los elementos 
        if (listaTarjetas != null) {
            for (TarjetaPersonalizada tarjeta : listaTarjetas) {
                Object[] objects = {tarjeta.getId_personalizada(), tarjeta.getEstado(), tarjeta.getNombrePropietario(), tarjeta.getIdentificacion(), tarjeta.getSaldo()};
